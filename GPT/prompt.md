...
Separar o codigo html, javascript e css -> Ele mudou todo o código

---- Copiei o primeiro código gerado (que estava condensado num arquivo único) e soliciei para:

Separe o código em html, js e css
-----
